...
class ShapeNetDataset(torch.utils.data.dataset.Dataset):
    ...
    def __getitem__(self, idx):
        taxonomy_name, sample_name, rendering_images, volume, img_paths = self.get_datum(idx)

        if self.transforms:
            rendering_images = self.transforms(rendering_images)

        return taxonomy_name, sample_name, rendering_images, volume, img_paths
    ...
    def get_datum(self, idx):
        ...
        return taxonomy_name, sample_name, np.asarray(rendering_images), volume, img_paths
