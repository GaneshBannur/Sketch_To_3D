...
def save_checkpoints(cfg, file_path, epoch_idx, encoder, encoder_solver, decoder, decoder_solver, refiner,
                     refiner_solver, merger, merger_solver, dino_projector, dino_projector_solver, best_iou,
                     best_epoch):
    ...
    checkpoint = {
        ...
        # 'dino_projector_state_dict': dino_projector.state_dict(),
        # 'dino_projector_solver_state_dict': dino_projector_solver.state_dict()
    }
